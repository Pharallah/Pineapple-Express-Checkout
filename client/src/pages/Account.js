            ...
            >
              ...
              <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                <button
                  ...
                  className="w-full rounded-md bg-red-500 px-4 py-2 text-lg font-medium text-white shadow-sm hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
                >
                  Logout
                </button>
              </div>
